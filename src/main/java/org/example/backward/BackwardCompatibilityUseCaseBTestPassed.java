...
public class BackwardCompatibilityUseCaseBTestPassed {

    private static final Logger log = LoggerFactory.getLogger(BackwardCompatibilityUseCaseBTestPassed.class);
