...
public class BackwardCompatibilityFailedTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Schema<MyRecordV3> schemaV2 = Schema.AVRO(
                SchemaDefinition.<MyRecordV3>builder().withAlwaysAllowNull
                        (false).withPojo(MyRecordV3.class).build());
        ...
        Producer<MyRecordV3> producerV2 = client.newProducer(schemaV2)
                .topic(topic)
                .create();
        MyRecordV3 recordV3 = new MyRecordV3();
        recordV3.setField1("V2-Field1");
        recordV3.setField3("V2-new-field");
        producerV2.send(recordV3);
        log.info("Send V2 schema message: {}", recordV3);
